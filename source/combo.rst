...
.. option:: linkding
	...
	``linkding --url "http://127.0.0.1:8002" --token "<Token>" bookmarks all -q $* | jq ".results[]" | ramda -c -o csv | xsv select id,tag_names,url,website_description | tidy-viewer -u 50``
